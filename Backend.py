...
#             response = {"error": "Missing 'input' field in JSON"}
#             print(json.dumps(response))
#             return
#
#         input_text = data["input"]
#
#         # Validate input (only uppercase letters)
#         if not all(c.isupper() or c.isspace() or not c.isalpha() for c in input_text):
#             response = {"error": "Input contains non-uppercase letters or invalid characters"}
#             print(json.dumps(response))
#             return
#
#         # Transform text
